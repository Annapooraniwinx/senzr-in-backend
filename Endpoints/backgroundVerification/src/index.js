...
//     try {
//       const { uanNumber } = req.body; //no permission in production api
...
//           break;
//         case "voter_id": //no permission in production api
//           endpoint = "https://kyc-api.surepass.app/api/v1/voter-id/voter-id";
//           requestBody = { id_number: documentNumber };
//           break;
//         case "driving_license": //no permission in production api
//           endpoint =
...
//         case "uan":
//           endpoint =
//             // "https://kyc-api.surepass.app/api/v1/income/epfo/aadhaar-to-uan";
