...
//         // Get the most recent leave type for this employee
...
//           cycleEndDate: endDate,
//           cycleType: fixedCycle ? "Fixed Cycle" : "Custom Cycle",
//           leaveType: leaveType, // Add leave type to the response
//           ...summary,
//         });
//       }
...
//         // Use the most recent leave type or "none" if no leave types exist
//         const leaveType = leaveTypes.length > 0 ? leaveTypes[0] : "none";
...
//         // Get all leave types for this month
...
//             day: record.day,
//             leaveType: record.leaveType || "none", // Add leave type to the response with default "none"
...
//             attendance: "noRecord",
//             day: null,
//             leaveType: "none", // Default to "none" for days with no record
...
//             cycleEndDate: endDate,
//             cycleType: fixedCycle ? "Fixed Cycle" : "Custom Cycle",
//             leaveType: leaveType, // Add leave type to the summary
//             ...monthlySummary,
//           },
